    ...
    <main class="app-content">
        ...
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-header d-flex justify-content-between align-items-center">
                    <h3 class="mb-3">Cadastro de Conta a Pagar</h3>
                ...
                <div id="formContainer" style="display: none;">
                    <div class="tile-body">
                        <form method="POST" action="{{ route('contas.store') }}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="tipo_conta" value="Pagar">
                            <div class="row">
                                <!-- Fornecedor -->
        ...
        <div class="tile">
            <h3 class="mb-3">Lista de Contas a Pagar</h3>

        <!-- Filtros -->
        <form method="GET" action="{{ route('contasPagar.index') }}" class="mb-4">
            <div class="row g-3">
                <!-- Filtro de Mês e Ano -->
                <div class="col-md-4">
