<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        <li><a class="app-menu__item active" href="/home"><i class="app-menu__icon bi bi-speedometer"></i><span
                    ...
                    @if (Auth::user()->permissoes->pluck('id')->intersect([2, 3])->isNotEmpty())
                        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                                    class="app-menu__icon bi bi-telephone-outbound"></i><span
        ...
        @if (Auth::user()->permissoes->pluck('id')->intersect([1, 3])->isNotEmpty())
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                        class="app-menu__icon bi bi-heart-pulse"></i><span class="app-menu__label">Médicos</span><i
                        class="treeview-indicator bi bi-chevron-right"></i></a>
                <ul class="treeview-menu">
                    <li><a class="treeview-item" href="{{ route('agenda.agendaMedica') }}"><i
                                class="icon bi bi-calendar2-check"></i> Atendimentos</a></li>
                    <li><a class="treeview-item" href="{{ route('atendimento.lista') }}"><i
                                class="icon bi bi-pencil-square"></i> Consultar Prontuários</a></li>
                </ul>
            </li>
        @endif
        @if (Auth::user()->permissoes->pluck('id')->intersect([3])->isNotEmpty())
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                        class="app-menu__icon bi bi bi-gear"></i><span class="app-menu__label">Cadastros</span><i
                        class="treeview-indicator bi bi-chevron-right"></i></a>
                <ul class="treeview-menu">
        ...
        @if (Auth::user()->permissoes->pluck('id')->intersect([3])->isNotEmpty())
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                        class="app-menu__icon bi bi-bank"></i><span class="app-menu__label">Financeiro</span><i
                        class="treeview-indicator bi bi-chevron-right"></i></a>
                <ul class="treeview-menu">
