            ...
            <form action="{{route('usuario.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-3">
                        ...
                        <input class="form-control" id="password" name="password" type="password" onmouseover="showPassword()" onmouseout="hidePassword()">
                    </div>
                </div>
                <div class="row">
                    <div class="mb-3 col-md-3">
                ...
                <div class="row">
                    ...
                    <div id="especialidade-div" class="mb-3 col-md-4 hidden">
                    ...
                    <div id="crm-div" class="mb-3 col-md-4 hidden">
                        <label class="form-label">CRM</label>
                        <input class="form-control" id="crm" name="crm" type="text">
                    </div>
                    <div id="corem-div" class="mb-3 col-md-4 hidden">
