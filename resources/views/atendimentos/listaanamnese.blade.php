                                                        ...
                                                        <form method="POST"
                                                            ...
                                                            <div class="row">
                                                                <div class="mb-3 col-md-3">
                                                                    <label
                                                                        class="form-label"><strong>Nascimento:</strong></label>
                                                                ...
                                                                <div class="mb-3 col-md-3">
                                                                    <label
                                                                        class="form-label"><strong>Idade:</strong></label>
                                                                    <input class="form-control" id="idade"
                                                                        name="idade" type="text" disabled>
                                                                </div>
                                                                <div class="mb-3 col-md-3">
